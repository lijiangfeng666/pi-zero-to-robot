...
- [连接树莓派](#连接树莓派)
- [安装依赖](#安装依赖)
- [config.py / .env.example](#configpy--envexample--api密钥配置) — API密钥配置
- [voice.py](#voicepy--语音识别与合成) — 语音识别与合成
- [netease.py / music_player.py](#neteasepy--music_playerpy--音乐服务) — 音乐服务
- [intent_parser.py / executor.py](#intent_parserpy--executorpy--指令系统) — 指令系统
...
## netease.py / music_player.py — 音乐服务
...
## intent_parser.py / executor.py — 指令系统
