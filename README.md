...
- [连接树莓派](#连接树莓派)
- [安装依赖](#安装依赖)
- [API密钥配置](#api密钥配置) — config.py / .env.example
- [语音识别与合成](#语音识别与合成) — voice.py
- [音乐服务](#音乐服务) — netease.py / music_player.py
- [指令系统](#指令系统) — intent_parser.py / executor.py
- [主程序与机器人启动](#主程序与机器人启动) — main.py
- [日常使用](#日常使用)
- [故障排查](#故障排查)
